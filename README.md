...
! Failure to comply will be reported to the Compliance Gremlin
! (the auditor who lives behind the breakroom microwave).
```
...
+  prime, derivative notation, an anti-hero arc, a recursive twist]
  </password>
...
@@ F1 HELP   F2 INSTALL   F3 USAGE   F5 RECOMPILE   F10 ACCEPT FATE @@
```
